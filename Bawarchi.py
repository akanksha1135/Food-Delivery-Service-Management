...
root.title("Bawarchi Menu Card")

Tops=Frame(root,width=1800,height=100,bd=12,relief="raise")
Tops.pack(side=TOP)
lblTitle=Label(Tops, font=('arial',30,'bold'),text="\tBawarchi restaurant\t")
...
btnOrder=Button(f3,padx=16,pady=1,bd=4,fg="black",font=('arial',16,'bold'),width=5,text="Order",command=Order_Request).grid(row=9,column=0)
